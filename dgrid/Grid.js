define([
	...
	var Grid = declare("dgrid.Grid",List, {
		...
		createRowCells: function createRowCells(tag, each, subRows, object) {
			// summary:
		...
		renderRow: function renderRow(object, options) {
			var self = this;
		...
		_configColumns: function _configColumns(prefix, rowColumns) {
